...
description: Découvrez comment utiliser les  [!DNL Commerce Intelligence] fonctionnalités disponibles pour Adobe Commerce.
...
# Guide de l’utilisateur [!DNL Commerce Intelligence] {#mbi}

- [Guide de l’utilisateur [!DNL Commerce Intelligence]](guide-overview.md)
- [[!DNL Commerce Intelligence] Introduction](getting-started/getting-started.md)
- Prise en main {#start}
   - [Intégration](getting-started/onboarding.md)
   - [Activation de votre compte  [!DNL Commerce Intelligence] ](getting-started/onpremise-activation.md)
   - [Connectez-vous à votre compte  [!DNL Commerce Intelligence] ](getting-started/sign-in.md)
   - [Commerce Intelligence Essentials par rapport à Commerce Intelligence Pro](getting-started/essentials-vs-pro.md)
...
- Analyser les données {#analyze}
   ...
   - Gestionnaire de Data Warehouse {#warehouse-manager}
      ...
      - [Construire [!DNL Google Ecommerce] dimensions](data-analyst/data-warehouse-mgr/bldg-google-ecomm-dim.md)
      ...
      - [Réplication des  [!DNL Google Analytics] canaux](data-analyst/data-warehouse-mgr/rep-google-analytics-channels.md)
      - [Normalisation des données avec les tableaux de mappage](data-analyst/data-warehouse-mgr/stndrd-data-map-tables.md)
      - [Traduire les requêtes SQL dans des rapports  [!DNL Commerce Intelligence] ](data-analyst/dev-reports/sql-queries-reports.md)
   ...
   - REPORT BUILDER SQL {#sql}
      - [Utilisation de la fonction [!DNL Cohort Report Builder]](data-analyst/dev-reports/cohort-rpt-bldr.md)
      - [Utilisation de  [!DNL Cohort Report Builder]  pour les cohortes non basées sur des dates](data-analyst/dev-reports/cohort-rpt-non-date-based.md)
      ...
      - [Créer des  [!DNL Google Analytics] graphiques](data-analyst/dev-reports/google-analytics-charts-regex.md)
      - [Importance de la  [!DNL Lifetime Revenue Cohort Analysis]](data-analyst/dev-reports/lifetime-rev-cohort-analysis.md)
      - [Commande des données à l’aide de la fonction  [!DNL Show Top/Bottom] ](data-analyst/dev-reports/order-data-top-bottom-feat.md)
      - [Utilisation de la fonction [!DNL SQL Report Builder]](data-analyst/dev-reports/sql-rpt-bldr.md)
      ...
      - [Mesures d’audit à l’aide de  [!DNL SQL Report Builder]](data-analyst/dev-reports/audit-metrics-sql.md)
   ...
   - Connexion aux données {#connecting}
      ...
      - [Importation de  [!DNL Bing Ad Spend] données](data-analyst/importing-data/connecting-data/import-bing-ad-data.md)
      - [Importation de données marketing  [!DNL CJ Affiliate]  (Commission Junction)](data-analyst/importing-data/connecting-data/import-cj-market-data.md)
      - [Importer des  [!DNL Linkshare] données](data-analyst/importing-data/connecting-data/import-linkshare-data.md)
      - [Importer des  [!DNL MailChimp] données](data-analyst/importing-data/connecting-data/import-mailchimp-data.md)
   ...
   - Intégrations SaaS {#saas}
      ...
      - [Présentation des résultats entre [!DNL Database] et [!DNL SQL] Editor](data-analyst/importing-data/integrations/last-success-update.md)
      ...
      - [Données  [!DNL Facebook Ads] attendues](data-analyst/importing-data/integrations/facebook-ads-data.md)
      - [Connexion [!DNL Google Adwords]](data-analyst/importing-data/integrations/google-adwords.md)
      - [Données  [!DNL Google Adword] attendues](data-analyst/importing-data/integrations/google-adwords-data.md)
      - [Audience [!DNL Google Adwords] data](data-analyst/importing-data/integrations/audit-google-adwords.md)
      ...
      - [Données  [!DNL Google Analytics] attendues](data-analyst/importing-data/integrations/google-analytics-data.md)
      - [Connexion [!DNL Google ECommerce]](data-analyst/importing-data/integrations/google-ecommerce.md)
      - [Données  [!DNL Google ECommerce] attendues](data-analyst/importing-data/integrations/google-ecommerce-data.md)
      - [Connexion [!DNL Mixpanel]](data-analyst/importing-data/integrations/mixpanel.md)
      - [Données  [!DNL Mixpanel] attendues](data-analyst/importing-data/integrations/mixpanel-data.md)
      ...
      - [Données  [!DNL Quickbooks] attendues](data-analyst/importing-data/integrations/quickbooks-data.md)
      - [Connexion [!DNL Salesforce]](data-analyst/importing-data/integrations/salesforce.md)
      - [Données  [!DNL Salesforce] attendues](data-analyst/importing-data/integrations/salesforce-data.md)
      ...
      - [Données  [!DNL Stripe] attendues](data-analyst/importing-data/integrations/stripe-data.md)
      ...
      - [Données  [!DNL Zendesk] attendues](data-analyst/importing-data/integrations/exp-zendesk-data.md)
      - [Analyse des  [!DNL Zendesk] données](data-analyst/importing-data/integrations/help-desk-zendesk.md)
      - [Audience [!DNL Zendesk] data](data-analyst/importing-data/integrations/audit-zendesk-data.md)
   - Intégrations de base de données {#integration}
      ...
      - [Connectez votre [!DNL MySQL Database] à [!DNL Commerce Intelligence]](data-analyst/importing-data/integrations/db-to-mbi.md)
      ...
      - [Connexion à  [!DNL MongoDB] via [!DNL SSH Tunnel]](data-analyst/importing-data/integrations/mongodb-via-ssh-tunnel.md)
      - [Connexion à  [!DNL MySQL]  via a [!DNL direct connection]](data-analyst/importing-data/integrations/mysql-via-a-direct-connection.md)
      - [Connexion à  [!DNL MySQL] via [!DNL cPanel]](data-analyst/importing-data/integrations/mysql-via-cpanel.md)
      - [Connexion à  [!DNL MySQL] via [!DNL SSH Tunnel]](data-analyst/importing-data/integrations/mysql-via-ssh-tunnel.md)
      - [Connexion [!DNL PostgreSQ]](data-analyst/importing-data/integrations/postgresql.md)
   - Analyser les campagnes {#campaigns}
   ...
   - Analyser les clients {#customers}
      ...
      - [[!DNL Expected Lifetime Value (LTV)] analyse (de base)](data-analyst/analysis/ess-expected-ltv.md)
      - [[!DNL Expected Lifetime Value (LTV)] analyse (avancée)](data-analyst/analysis/expected-customer-ltv.md)
      - [Présentation des données de Source sur le suivi des acquisitions d’utilisateurs](data-analyst/analysis/google-track-user-acq.md)
   ...
   - Analyse des performances de l’entreprise {#performance}
      ...
      - [Présentation de l’attribution  [!DNL Google Analytics] UTM](data-analyst/analysis/utm-attributes.md)
...
- Bonnes pratiques {#best-practices}
   - Utilisation des données {#data}
      ...
      - [Présentation de votre environnement  [!DNL Commerce Intelligence] ](best-practices/understanding-magento.md)
   - Organisation de projet {#project}
      ...
      - [Désencombrer votre compte  [!DNL Commerce Intelligence] ](best-practices/declutter-account.md)
...
- Tutorials {#tutorials}
   - [Utilisation de la fonction [!DNL Visual Report Builder]](tutorials/using-visual-report-builder.md)
   - [Utilisation des options d’heure dans le  [!DNL Visual Report Builder]](tutorials/time-options-visual-rpt-bldr.md)
