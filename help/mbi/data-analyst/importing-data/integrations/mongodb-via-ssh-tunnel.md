...
description: Découvrez comment connecter en toute sécurité votre base de données MongoDB à Commerce Intelligence à l’aide d’un tunnel SSH, y compris les étapes clés de configuration et de configuration de la connexion.
