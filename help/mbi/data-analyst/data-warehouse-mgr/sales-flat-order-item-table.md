...
| `product_type` | Type de produit vendu. Les [types de produits](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/product-create.html?lang=fr#product-types) potentiels incluent : simple, configurable, groupé, virtuel, groupé et téléchargeable. |
