...
Lorsqu&#39;un produit configurable est inclus dans une commande, deux lignes sont générées dans le tableau de `sales_order_item` : une pour le `sku` [simple](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/products/types/product-create-simple) et une pour le parent [configurable](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/products/types/product-create-configurable). Ces deux enregistrements de la table `sales_order_item` peuvent être mis en relation l&#39;un avec l&#39;autre à travers la jointure suivante :
...
|----|----|
| `base_price` | Prix d&#39;une unité individuelle d&#39;un produit au moment de la vente après l&#39;application des [règles de prix de catalogue, remises échelonnées et prix spéciaux](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/products/pricing/pricing-advanced) et avant l&#39;application des remises sur les taxes, les frais d&#39;expédition ou le panier. Elle est représentée dans la devise de base du magasin. |
...
| `product_type` | Type de produit qui a été vendu. Les [types de produits](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/products/product-create#product-types) potentiels sont les suivants : simple, configurable, groupé, virtuel, groupé et téléchargeable. |
...
| `Order item total value (quantity * price)` | Valeur totale d&#39;un article de commande au moment de la vente après l&#39;application des [règles de prix de catalogue, remises échelonnées et prix spéciaux](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/products/pricing/pricing-advanced) et avant l&#39;application des remises sur les taxes, les frais d&#39;expédition ou le panier. Calculé en multipliant le `qty_ordered` par le `base_price`. |
...
* Rejoignez les `sales_order_item` pour créer des colonnes qui associent les détails du SKU parent configurable ou groupé au produit simple. [Contactez l’assistance &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies) pour obtenir de l’aide sur la configuration de ces calculs, si vous créez dans le gestionnaire Data Warehouse.
