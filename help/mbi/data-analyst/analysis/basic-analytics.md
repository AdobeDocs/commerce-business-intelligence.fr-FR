...
*Si tel est le cas, ce tableau peut ne pas contenir tous vos clients. Contactez l’[équipe d’assistance](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies) pour vous assurer que vos analyses client incluent tous les clients.*
...
Source d’acquisition&rbrack;(../../assets/acquisition_source.png)<!--{: width="929"}-->!&lbrack;
...
Medium d’acquisition&rbrack;(../../assets/acquisition_medium.png)<!--{: width="929"}-->!&lbrack;
