...
Cet article explique comment configurer la structure pour utiliser une [4-5-4 calendrier de vente au détail](https://nrf.com/resources/4-5-4-calendar) dans votre [!DNL MBI] compte . Le créateur de rapports visuel fournit des périodes, des intervalles et des paramètres indépendants incroyablement flexibles. Cependant, tous ces paramètres fonctionnent avec le calendrier mensuel traditionnel en place.
