...
description: Découvrez les bonnes pratiques de formatage et d’importation des données financières dans Commerce Intelligence, afin que votre entrepôt de données reste précis et facile à analyser.
